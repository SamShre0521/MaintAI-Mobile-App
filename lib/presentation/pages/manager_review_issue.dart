...
class _ManagerReviewIssuePageState extends State<ManagerReviewIssuePage> {
  final TextEditingController commentController =
      TextEditingController(text: 'Valid solution');
      ...
      child: Column(
        ...
        children: [
          ...
          _CompactInfoRow(
            ...
            label: 'Status',
            value:
                feedback.managerStatus.isEmpty ? 'pending' : feedback.managerStatus,
          ),
        ...
        children: [
          Icon(
            isCorrect
                ...
                : Icons.info_outline_rounded,
            color:
                isCorrect ? const Color(0xFF22C55E) : const Color(0xFFF97316),
          ),
          const SizedBox(width: 10),
          Expanded(
            child: Text(
